...
class BlogColors {
    ...
    init() {
        let colorTop = UIColor(red: 110.0 / 255.0, green: 146.0 / 255.0, blue: 171.0 / 255.0, alpha: 1.0).cgColor
        let colorBottom = UIColor(red: 60.0 / 255.0, green: 78.0 / 255.0, blue: 91.0 / 255.0, alpha: 1.0).cgColor
